    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            //级联表 家属
            //级联表
            JiashuEntity jiashu = jiashuService.selectById(yonghu.getJiashuId());
            jiashu.setUsername(yonghu.getUsername());
            if(jiashu != null){
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(false)
            ...
            yonghu.setJiashuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者紧急联系方式已经被使用");
        }
    }
...
//                            yonghuEntity.setYonghuName(data.get(0));                    //老人姓名 要改的
//                            yonghuEntity.setYonghuPhoto("");//详情和图片
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setJiankangTypes(Integer.valueOf(data.get(0)));   //健康状态 要改的
//                            yonghuEntity.setYonghuAge(Integer.valueOf(data.get(0)));   //年龄 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //紧急联系方式 要改的
//                            yonghuEntity.setYonghuAddress(data.get(0));                    //住址 要改的
//                            yonghuEntity.setBaojingTypes(Integer.valueOf(data.get(0)));   //健康报警 要改的
//                            yonghuEntity.setJiashuId(Integer.valueOf(data.get(0)));   //家属 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [紧急联系方式] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "老人");
        R r = R.ok();
        r.put("token", token);
        r.put("role","老人");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者紧急联系方式已经被使用");
        yonghu.setYonghuDelete(1);
        yonghu.setInsertTime(new Date());
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
    ...
    */
    ...
    public R getCurrYonghu(HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            jiashu.setUsername(yonghu.getUsername());
            if(jiashu != null){
                BeanUtils.copyProperties( jiashu , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                view.setJiashuId(jiashu.getId());
            }
            //修改对应字典表字段
            dictionaryService.dictionaryConvert(view, request);
