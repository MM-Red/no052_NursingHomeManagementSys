...
public class WaichuController {
    ...
    */
    ...
    public R page(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        params.put("waichuDeleteStart",1);params.put("waichuDeleteEnd",1);
...
//            waichu.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        ArrayList<WaichuEntity> list = new ArrayList<>();
        for(Integer id:ids){
            WaichuEntity waichuEntity = new WaichuEntity();
            waichuEntity.setId(id);
            waichuEntity.setWaichuDelete(2);
            list.add(waichuEntity);
        }
        if(list != null && list.size() >0){
            waichuService.updateBatchById(list);
        }
                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            WaichuEntity waichuEntity = new WaichuEntity();
//                            waichuEntity.setWaichuName(data.get(0));                    //标题 要改的
//                            waichuEntity.setWaichuTypes(Integer.valueOf(data.get(0)));   //外出目的 要改的
//                            waichuEntity.setWaichuTime(sdf.parse(data.get(0)));          //外出时间 要改的
//                            waichuEntity.setHuiliaTime(sdf.parse(data.get(0)));          //回来时间 要改的
//                            waichuEntity.setYonghuId(Integer.valueOf(data.get(0)));   //老人 要改的
//                            waichuEntity.setWaichuText(data.get(0));                    //备注 要改的
//                            waichuEntity.setWaichuContent("");//详情和图片
//                            waichuEntity.setWaichuDelete(1);//逻辑删除字段
