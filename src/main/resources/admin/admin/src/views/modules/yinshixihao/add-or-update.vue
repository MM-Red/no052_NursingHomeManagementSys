    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="食物名称" prop="yinshixihaoName">
                       <el-input v-model="ruleForm.yinshixihaoName"
                                 placeholder="食物名称" clearable  :readonly="ro.yinshixihaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="食物名称" prop="yinshixihaoName">
                           <el-input v-model="ruleForm.yinshixihaoName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yinshixihaoPhoto" label="食物照片" prop="yinshixihaoPhoto">
                        <file-upload
                            tip="点击上传食物照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yinshixihaoPhoto?$base.url+ruleForm.yinshixihaoPhoto:''"
                            @change="yinshixihaoPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yinshixihaoPhoto" label="食物照片" prop="yinshixihaoPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.yinshixihaoPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="食物类型" prop="yinshixihaoTypes">
                        <el-select v-model="ruleForm.yinshixihaoTypes" :disabled="ro.yinshixihaoTypes" placeholder="请选择食物类型">
                            <el-option
                                v-for="(item,index) in yinshixihaoTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="食物类型" prop="yinshixihaoValue">
                        <el-input v-model="ruleForm.yinshixihaoValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="食物介绍" prop="yinshixihaoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yinshixihaoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yinshixihaoContent" label="食物介绍" prop="yinshixihaoContent">
                            <span v-html="ruleForm.yinshixihaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    yinshixihaoName: false,
                    yinshixihaoPhoto: false,
                    yinshixihaoTypes: false,
                    yonghuId: false,
                    yinshixihaoContent: false,
                    yinshixihaoDelete: false,
                },
                ruleForm: {
                    yinshixihaoName: '',
                    yinshixihaoPhoto: '',
                ...
                rules: {
                   ...
                   yinshixihaoPhoto: [
                              { required: true, message: '食物照片不能为空', trigger: 'blur' },
                          ],
                   yinshixihaoTypes: [
                   ...
                   yinshixihaoContent: [
                              { required: true, message: '食物介绍不能为空', trigger: 'blur' },
                          ],
                   yinshixihaoDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yinshixihao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yinshixihaoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `yinshixihao/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.yonghuChange(data.data.yonghuId)
                        _this.ruleForm.yinshixihaoContent = _this.ruleForm.yinshixihaoContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yinshixihaoContent = this.ruleForm.yinshixihaoContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yinshixihao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yinshixihaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            yinshixihaoPhotoUploadChange(fileUrls){
                this.ruleForm.yinshixihaoPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
