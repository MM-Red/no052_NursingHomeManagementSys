    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="waichuName">
                       <el-input v-model="ruleForm.waichuName"
                                 placeholder="标题" clearable  :readonly="ro.waichuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="waichuName">
                           <el-input v-model="ruleForm.waichuName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="外出目的" prop="waichuTypes">
                        <el-select v-model="ruleForm.waichuTypes" :disabled="ro.waichuTypes" placeholder="请选择外出目的">
                            <el-option
                                v-for="(item,index) in waichuTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="外出目的" prop="waichuValue">
                        <el-input v-model="ruleForm.waichuValue"
                            placeholder="外出目的" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="外出时间" prop="waichuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.waichuTime"
                                type="datetime"
                                placeholder="外出时间"
                                :disabled="ro.waichuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.waichuTime" label="外出时间" prop="waichuTime">
                            <span v-html="ruleForm.waichuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="回来时间" prop="huiliaTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.huiliaTime" label="回来时间" prop="huiliaTime">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="waichuText">
                        <el-input type="textarea"  :readonly="ro.waichuText" v-model="ruleForm.waichuText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.waichuText" label="备注" prop="waichuText">
                            <span v-html="ruleForm.waichuText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="waichuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.waichuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.waichuContent" label="详情" prop="waichuContent">
                            <span v-html="ruleForm.waichuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   waichuTypes: [
                              { required: true, message: '外出目的不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   huiliaTime: [
                              { required: true, message: '回来时间不能为空', trigger: 'blur' },
                          ],
                   yonghuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=waichu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.waichuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.waichuContent = _this.ruleForm.waichuContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.waichuContent = this.ruleForm.waichuContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`waichu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.waichuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
