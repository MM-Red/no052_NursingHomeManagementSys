    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="标题" prop="shiguName">
                       <el-input v-model="ruleForm.shiguName"
                                 placeholder="标题" clearable  :readonly="ro.shiguName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="标题" prop="shiguName">
                           <el-input v-model="ruleForm.shiguName"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="事故时间" prop="shiguTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.shiguTime"
                                type="datetime"
                                placeholder="事故时间"
                                :disabled="ro.shiguTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiguTime" label="事故时间" prop="shiguTime">
                            <span v-html="ruleForm.shiguTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="地点" prop="shiguAddress">
                       <el-input v-model="ruleForm.shiguAddress"
                                 placeholder="地点" clearable  :readonly="ro.shiguAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="地点" prop="shiguAddress">
                           <el-input v-model="ruleForm.shiguAddress"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="事故类型" prop="shiguTypes">
                        <el-select v-model="ruleForm.shiguTypes" :disabled="ro.shiguTypes" placeholder="请选择事故类型">
                            <el-option
                                v-for="(item,index) in shiguTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="事故类型" prop="shiguValue">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="严重程度" prop="yanzhengTypes">
                        <el-select v-model="ruleForm.yanzhengTypes" :disabled="ro.yanzhengTypes" placeholder="请选择严重程度">
                            <el-option
                                v-for="(item,index) in yanzhengTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="严重程度" prop="yanzhengValue">
                        <el-input v-model="ruleForm.yanzhengValue"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="shiguText">
                        <el-input type="textarea"  :readonly="ro.shiguText" v-model="ruleForm.shiguText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiguText" label="备注" prop="shiguText">
                            <span v-html="ruleForm.shiguText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="shiguContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.shiguContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shiguContent" label="详情" prop="shiguContent">
                            <span v-html="ruleForm.shiguContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shigu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shiguTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yanzheng_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yanzhengTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.shiguContent = _this.ruleForm.shiguContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.shiguContent = this.ruleForm.shiguContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`shigu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shiguCrossAddOrUpdateFlag = false;
                                        this.parent.search();
