<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='qinshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="寝室位置" prop="qinshiName">
                        <el-input v-model="qinshiForm.qinshiName"
                                  placeholder="寝室位置" clearable readonly></el-input>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='qinshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="寝室类型" prop="qinshiValue">
                        <el-input v-model="qinshiForm.qinshiValue"
                                  placeholder="寝室类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                ...
                <el-col :span="12"  v-if="sessionTable !='qinshi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="寝室状态" prop="statusValue">
                        <el-input v-model="qinshiForm.statusValue"
                                  placeholder="寝室状态" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="寝室状态" prop="statusValue">
            ...
            <input id="qinshiId" name="qinshiId" type="hidden">
            </el-row>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.$route.query.qinshiId){
				this.ruleForm.qinshiId = this.$route.query.qinshiId
				this.qinshiChange(this.$route.query.qinshiId)
            }
         ...
         this.$http({
             url: `qinshi/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.qinshiOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `qinshifenpei/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.qinshiChange(data.data.qinshiId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`qinshifenpei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        // this.parent.qinshifenpeiCrossAddOrUpdateFlag = false;
                                        // this.parent.search();
