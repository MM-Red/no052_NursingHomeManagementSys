...
<style lang="scss" scoped>
  ...
  .index-aside {
	...
	.menulist-item {
		...
		background: transparent url("http://codegen.caihongy.cn/20220122/a8e8d119233e42f3bc5c5ec434c78489.png") no-repeat top !important;
		...
		&>.el-menu-item {
			...
			border-style: solid;
			border-color: rgba(33, 71, 97, 1) !important;
			background-color: rgba(255,255,255,1) !important;
			box-shadow: 0 0 0px  #214761;
			box-sizing: initial;
			display: flex;
			align-items: center;
		...
		& /deep/ .el-menu.el-menu--inline {
			...
			.el-menu-item {
                ...
                &.is-active {
                    ...
                    padding: 0 !important;
                    margin: 0;
                    color: rgba(33, 71, 97, 1) !important;
                    font-size: 14px;
                    border-radius: 0;
