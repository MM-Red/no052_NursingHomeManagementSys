	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"rgba(255, 255, 255, 1)","headFontSize":"28px","headUserInfoFontColor":"rgba(0, 0, 0, 1)","headBoxShadow":"0 0px 0px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"rgba(136, 172, 190, 1)","headFontColor":"rgba(0, 0, 0, 1)","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"transparent url(\"http://codegen.caihongy.cn/20220122/cb241c3f271f4613aed31dfdb0992911.png\") no-repeat top","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(0, 0, 0, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"2","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
